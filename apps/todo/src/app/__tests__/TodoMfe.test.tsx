...
import type { TodoFeatureData } from '../../contract';
...
function envelope(feature: TodoFeatureData = {}) {
...
describe('TodoMfe', () => {
  ...
  it('cancels edits and shows empty filter status', async () => {
    ...
    expect(screen.getByText('No todos for this filter.')).toBeTruthy();
